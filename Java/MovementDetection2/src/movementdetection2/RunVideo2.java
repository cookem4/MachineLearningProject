...
public class RunVideo2 {
	...
	String cmdString = "C:\\Users\\mitch\\AppData\\Local\\Programs\\Python\\Python36\\python.exe C:\\Users\\mitch\\AppData\\Local\\Programs\\Python\\Python36\\keras_testV2.py";
			...
			if(!camera.read(frame)) {
				...
				*/
				if(prediction.length()!=0) {
					//For V2
					if(prediction.length() > 14) {
						Imgproc.putText(frame, prediction, new Point(20,40), Core.FONT_HERSHEY_COMPLEX, 1, new Scalar(0,255,255));
						humanNotFound = true;
					}
					else {
						 Imgproc.putText(frame, "Human Found", new Point(20,40), Core.FONT_HERSHEY_COMPLEX, 1, new Scalar(0,255,0));
						 humanNotFound = false;
					}
